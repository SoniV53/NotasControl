...
@Component({
  selector: 'app-carpetas-articulos',
  templateUrl: './carpetas-articulos.component.html',
  styleUrl: './carpetas-articulos.component.scss'
})
export class CarpetasArticulosComponent extends ConfiguracionPageComponent implements OnInit, OnChanges {
  @Input() carpeta: Carpeta | null = null;
  ...
  async actionInit() {
    ...
    if (this.carpeta) {
      this.loading = true;
      this.rastroCarpeta.push(this.carpeta);
